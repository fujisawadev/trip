...
def connect_instagram():
    ...
    scope = "instagram_business_manage_comments,instagram_business_content_publish,instagram_business_manage_insights,instagram_basic,instagram_manage_messages,pages_manage_metadata"
