...
class SocialPost(db.Model):
    ...
    post_url = db.Column(db.Text, nullable=False)  # 投稿URL
    post_id = db.Column(db.Text, nullable=True)  # プラットフォーム上の投稿ID
    thumbnail_url = db.Column(db.Text, nullable=True)  # サムネイルURL
